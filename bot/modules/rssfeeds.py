...
from bot import LOGGER, dispatcher, updater, rss_session, \
...
from bot.helper.ext_utils.db_handler import postgres, rss_dict
...
def rss_init():
    ...
    dispatcher.add_handler(CommandHandler(BotCommands.RssHelpCommand, cmd_rsshelp, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
    dispatcher.add_handler(CommandHandler("feeds", cmd_rss_list, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
    dispatcher.add_handler(CommandHandler("get", cmd_get, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
    dispatcher.add_handler(CommandHandler("sub", cmd_rss_sub, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
    dispatcher.add_handler(CommandHandler("unsub", cmd_rss_unsub, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
    dispatcher.add_handler(CommandHandler("unsuball", cmd_rss_unsuball, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True))
